    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1 text-sm">Inventory & Order Management</p>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="space-y-1 text-xs text-gray-600">
            <p><span className="font-medium">Admin:</span> admin@aasachemchem.com / admin123</p>
            <p><span className="font-medium">Seller:</span> seller@aasachemchem.com / seller123</p>
          </div>
        </div>
